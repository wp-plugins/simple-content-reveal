...
function artiss_plugin_ads( $trans, $width = 750 ) {
    ...
    $code .= '<span style="font-weight: bold">' . __( 'Donate</span>', $trans ) . $newline;
...
function artiss_fetch_ad_code( $ad_number ) {
    ...
    if ( $ad_number == 3 ) { $ad_code = '<a href="http://wpengine.com?a_aid=4ffa9d884083e&amp;a_bid=67cf509b" target="_top"><img src="http://cdn.wpengine.com/wp-content/uploads/2012/03/Feature-Fast-125x125.jpg" alt="" title="" width="125" height="125" /></a>'; }
